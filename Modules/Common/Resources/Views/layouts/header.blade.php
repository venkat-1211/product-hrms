    ...
    <div class="main-header">
        ...
        <div class="header-user">
            <div class="nav user-menu nav-list">
                ...
                <div class="me-auto d-flex align-items-center" id="header-search">
                    ...
                    @role('ceo')
                        <a href="@role('super_admin') profile-settings.html  @else {{ route('company.profile.setting', $company->account_url) }} @endrole" class="btn btn-menubar">
                                            ...
                                            <ul>
                                                <li class="submenu">
                                                    <a href="javascript:void(0);">General Settings<span
                                                            class="menu-arrow"></span></a>
                                                    <ul>
                                                        <li><a href="@role('super_admin') profile-settings.html  @else {{ route('company.profile.setting', $company->account_url) }} @endrole">Profile</a></li>
                    ...
                    <div class="dropdown profile-dropdown">
                        <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                            <span class="avatar avatar-sm online">
                                <img src="{{ !empty(Auth::user()->profile->profile_image) ? Storage::url(Auth::user()->profile->profile_image) : Storage::url('assets/img/users/profile/user.png') }}" alt="Img" class="img-fluid rounded-circle">
                            </span>
                        </a>
                            ...
                            <div class="card mb-0">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-lg me-2 avatar-rounded">
                                            <img src="{{ !empty(Auth::user()->profile->profile_image) ? Storage::url(Auth::user()->profile->profile_image) : Storage::url('assets/img/users/profile/user.png') }}" alt="img">
                                        </span>
                                        <div>
                                            <h5 class="mb-0">{{ Auth::user()->username }}</h5>
                                            <p class="fs-12 fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2b5c4a59594e456b4e534a465b474e05484446">[email&#160;protected]</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <a class="dropdown-item d-inline-flex align-items-center p-0 py-2" href="@role('super_admin') profile-settings.html  @else {{ route('company.profile.setting', $company->account_url) }} @endrole">
                                ...
                                <div class="card-footer py-1">
                                    <a class="dropdown-item d-inline-flex align-items-center p-0 py-2"
                                        href="@role('super_admin')
                                                    {{ route('logout') }}
                                                @else
                                                    {{ route('company.logout', ['company' => $company->account_url]) }}
                                                @endrole">
        ...
        <div class="dropdown mobile-user-menu">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="@role('super_admin') profile-settings.html  @else {{ route('company.profile.setting', $company->account_url) }} @endrole">Settings</a>
